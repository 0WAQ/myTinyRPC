...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::myrpc::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::myrpc::RpcHeader, service_name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::myrpc::RpcHeader, method_name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::myrpc::RpcHeader, args_size_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::myrpc::_RpcHeader_default_instance_),
};
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:myrpc.RpcHeader)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:myrpc.RpcHeader)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:myrpc.RpcHeader)
  return false;
#undef DO_
}
...
void RpcHeader::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:myrpc.RpcHeader)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:myrpc.RpcHeader)
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::myrpc::RpcHeader* Arena::CreateMaybeMessage< ::myrpc::RpcHeader >(Arena* arena) {
